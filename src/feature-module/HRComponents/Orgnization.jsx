      ...
      <div className="py-3">
        ...
        <div className="row g-3 mx-4">
          <div className="col-md-6">
            <div className="d-flex flex-column p-3 rounded" style={{backgroundColor: "rgb(245 245 245)", height: "70%", width:"70%"}}>
              <h5 className="text-start">Total Tasks by Assignee</h5>
              <canvas ref={pieChartRef} style={{ 
        width: "50%", 
        height: "50%",
        margin: "10px"
      }}  />
          ...
          <div className="col-md-6">
            <div className="d-flex flex-column p-3 rounded" style={{backgroundColor: "rgb(245 245 245)"}}>
              <h5 className="text-start">Open Tasks by Assignee</h5>
              <canvas ref={barChartRef} style={{  }} />
            </div>
          </div>
        </div>
